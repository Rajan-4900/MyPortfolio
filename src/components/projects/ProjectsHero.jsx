    ...
    <section className="relative pt-24 pb-16 overflow-hidden border-b border-white/5">
      ...
      <div className="text-center max-w-3xl mx-auto px-4">
        ...
        >
          ...
          <span className="text-sm font-medium text-slate-300 tracking-wider uppercase">Portfolio Showcase</span>
        </motion.div>
        ...
        >
          Explore a curated selection of my technical projects, featuring scalable web applications, dynamic interfaces, and robust backend architectures.
        </motion.p>
      </div>
    </section>
  );
